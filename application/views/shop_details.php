...
$bannerBgClass='';
$bannerBgStyle='';
if(empty($shop_details['shop'][0]['featured_image'])) {
    $bannerBgClass = 'shop-detail-banner';
} else {
    $bannerBgStyle="background-image:url({$shop_details['shop'][0]['featured_image']})";
}
?>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="heading-title">
					<h2><?php echo $this->lang->line('order_food_from') ?> <?php echo $shop_details['shop'][0]['name']; ?></h2>
				</div>
				...
				<div class="search-dishes">
					<form action="#" id="#" class="inner-pages-form">
						...
						<div class="form-group search-shop">
							...
							<input type="button" name="Search" value="Search" class="btn" onclick="searchMenuDishes(<?php echo $shop_details['shop'][0]['shop_id']; ?>)">
						</div>
					</form>
				</div>
