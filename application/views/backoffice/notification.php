                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a class="btn danger-btn btn-sm" href="<?php echo base_url().ADMIN_URL;?>/notification/add"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            {?>
                                <div class="alert alert-success">
                                    <strong><?php echo $this->lang->line('success'); ?>!</strong> <?php echo $this->session->flashdata('NotificationMSG');?>
                                </div>
                            <?php } ?>
