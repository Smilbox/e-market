        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                       <?php echo $this->lang->line('sub-store-type') ?>
                    </h3>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box red">
                            <div class="portlet-title">
                                <div class="caption"><?php echo $this->lang->line('sub-store-type') ?></div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                        <thead>
                                            <tr role="row" class="heading">
                                                ...
                                                <th><?php echo $this->lang->line('store-type') ?></th>
                                            ...
                                            <tr role="row" class="filter">
                                                <td></td>  
                                                <td><input type="text" class="form-control form-filter input-sm" name="store_type"></td>                                     
