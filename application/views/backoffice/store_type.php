        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                       <?php echo $this->lang->line('store-type') ?>
                    </h3>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box red">
                            <div class="portlet-title">
                                <div class="caption"><?php echo $this->lang->line('store-type') ?></div>
                                <div class="actions c-dropdown">                                     
                                    <a class="btn danger-btn btn-sm" href="<?php echo base_url().ADMIN_URL;?>/sub_store_type/view"><i class="fa fa-plus"></i> <?php echo $this->lang->line('sub-store-type') ?></a>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                        <thead>
                                            <tr role="row" class="heading">
                                                ...
                                                <th><?php echo $this->lang->line('name') ?> EN</th>
                                                <th><?php echo $this->lang->line('name') ?> FR</th>
                                                <th><?php echo $this->lang->line('action') ?></th>
                                            </tr>
                                            <tr role="row" class="filter">
                                                <td></td>  
                                                <td><input type="text" class="form-control form-filter input-sm" name="name_en"></td>                                     
                                                <td><input type="text" class="form-control form-filter input-sm" name="name_fr"></td>
