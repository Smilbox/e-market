...
.div_2{text-align:left;width:35%;float:left;padding:5px 0 5px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;}
        	...
        	<?php $item_detail = unserialize($menu_item->item_detail);
        	 if(!empty($item_detail)){ $Subtotal = 0; $i = 1;
	            ...
	            <div  class="b0">
		            ...
		            <div class="div_2" role="text" title="<?php echo $value['item_name']; ?><?php echo $addons_name_list; ?>" ><?php echo $value['item_name']; ?><?php echo $addons_name_list; ?></div>
