        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                       <?php echo $this->lang->line('addons_category') ?>
                    </h3>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box red">
                            <div class="portlet-title">
                                <div class="caption"><?php echo $this->lang->line('addons_category') ?></div>
        ...
        callback: function (disableConfirm) {   
            if (disableConfirm) {
                jQuery.ajax({
                  ...
                  dataType : "json",
                  url : 'ajaxDisable',
                  data : {'entity_id':ID,'status':Status,'tblname':'add_ons_category'},
                  success: function(response) {
                       grid.getDataTable().fnDraw(); 
                  },
                  error: function(XMLHttpRequest, textStatus, errorThrown) {           
