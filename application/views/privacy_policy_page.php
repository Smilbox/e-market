...
<section class="inner-banner" style="background-image: url('<?php echo ($privacy_policy[0]->image)?image_url.$privacy_policy[0]->image:cms_banner_img?>');">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <?php if (!empty($privacy_policy)) { ?>
                    <div class="high-line-height"><?php echo htmlspecialchars_decode(stripslashes($privacy_policy[0]->description)); ?></div>
                <?php } ?>
            </div>
        </div>
    </div>
